...
$words = [
    "GALGJE", "VLINDER", "APPEL", "JAVASCRIPT", "DUBBEL",
    "GEWOON", "SOEP"
];
    ...
    <div>
        ...
        <div>
            ...
            <?php if ($WON  && gameComplete()) : ?>
                <p style="color: darkgreen; font-size: 25px;">Je hebt gewonnen het woord was <?php echo getCurrentWord() ?></p>
            <?php elseif (!$WON  && gameComplete()) : ?>
                <p style="color: darkred; font-size: 25px;">je hebt verloren het woord was <?php echo getCurrentWord() ?></p>
            <?php endif; ?>
        </div>
        ...
        <div style="float:right; display:inline; vertical-align:top;">
            ...
            <div style="display:inline-block;">
                <form method="get">
                    ...
                    ?>
                    <br><br>
                    <button type="submit" name="start">opnieuw spelen</button>
                </form>
            </div>
        </div>
        <br>
